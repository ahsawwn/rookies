---
name: Checkout Redirect Bug
about: Cart checkout button redirects to home page instead of checkout page
title: "[BUG] Proceed to Checkout button redirects to home page"
...
## Additional Context
This issue needs to be fixed to ensure a smooth checkout flow for users.

## Priority
Medium - Affects user experience during checkout process
